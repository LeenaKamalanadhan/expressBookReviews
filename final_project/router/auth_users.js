...
regd_users.delete("/auth/review/:isbn", (req, res) => {
    // Retrieve the ISBN and username
    const isbn = req.params.isbn;
    const username = req.session.authorization?.username;
    ...
    // Get the current reviews for the book
    let bookReviews = books[isbn].reviews;

    // Filter out the review made by the logged-in user
    const initialLength = bookReviews.length;
    ...
    if (bookReviews.length < initialLength) {
